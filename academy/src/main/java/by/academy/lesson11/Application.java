...
//е) Создать статический метод printMagazines(Printable[] printable) в классе 
//Magazine, который выводит на консоль названия только журналов.  Создать статический
...
public class Application {
	public static void main(String[] args) {
		...
		booksAndMagazines [0]=new Book ("Оруэл");
